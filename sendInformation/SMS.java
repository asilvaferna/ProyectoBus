...
//        
////Iniciamos una contraseña automatica
//        PWD generator = new PWD ();
//
...
//        parametersList.add(new BasicNameValuePair("dest", "34605720600"));//
//        generator.setPWD();
//        mensaje  = String.valueOf("COMPROBACIÓN DE IDENTIDAD.\n\n Su código de verificación es: "+generator.getPWD());
//        
